...
export const Hobbies = () => {
  ...
  return (
    <section id="hobbies" className="bg-[#FAF7F2] scroll-mt-24 overflow-hidden">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 pt-24 pb-10">
        <p className="text-sm tracking-wide uppercase text-gray-500"></p>
        ...
        <h2 className="mt-3 leading-[0.95] font-semibold text-[#141414] text-[42px] sm:text-[72px] md:text-[92px]">
          What I do outside work
        </h2>

        <p className="mt-10 text-[13px] font-semibold uppercase tracking-[0.10em] text-gray-700 leading-relaxed">
          When I'm not coding, you'll find me immersed in my hobbies,capturing moments through photography, exploring new destinations, and indulging in the art of cooking. These passions fuel my creativity and bring balance to my life.
        </p>
        </motion.div>
      </div>
          ...
          >
            {items.map((img, idx) => (
              <motion.div
                ...
                className={[
               "relative overflow-hidden border border-black/5",
               tileClass(img.shape),
               ].join(" ")}
